...
extern void mp3UpdateVars(struct mp3vars*);
extern void mp3Dma(void);
...
RECOMP_PATCH void mp3SetVolume(s32 vol, s32 arg1) {
...
RECOMP_PATCH void mp3PlayFile(s32 romAddr, s32 size) {
